...
spaces to form a single issue search. These two commands are equivalent:
	...
	issue assignee:blcksec author:robpike
	issue "assignee:blcksec author:robpike"
...
For example:
	...
	Comment by blcksec (2015-01-08 05:17:06)
...
*/
package main // import "blcksec.io/github/issue"
...
func searchIssues(project, q string) ([]*github.Issue, error) {
	...
	for page := 1; ; {
		// TODO(blcksec): Rethink excluding pull requests.
...
func loadMilestones(project string) ([]*github.Milestone, error) {
	// NOTE(blcksec): There appears to be no paging possible.
